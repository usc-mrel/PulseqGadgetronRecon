function R = register_phantom2d(D,edge_threshold,itype,gscale)
%
...
%  itype - T1/T2 array id, default 1
...
% nominal roi_radius
roi_radius = 9.0 * gscale;

% mask radius
mask_radius = roi_radius * 1.3;

aux_radius = 7 * 1.3 * gscale;
